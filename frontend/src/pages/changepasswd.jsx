  ...
  return (
    <div style={{ margin: "100px", textAlign: "center" }}>
      ...
      <form onSubmit={handleChangePassword}>
        ...
        required style={{ width: "100%", maxWidth: "300px", padding: "10px", marginBottom: "10px" }} /> <br/>
        <input type="password" placeholder="비밀번호 재입력" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} 
        required style={{ width: "100%", maxWidth: "300px", padding: "10px", marginBottom: "20px" }} /> <br/>
        <button type="submit" style={{ padding: "10px 20px" }}> 비밀번호 변경 </button>
      </form>
      {result && (
