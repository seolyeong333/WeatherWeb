...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(jwtAuthInterceptor)
                ...
                .excludePathPatterns("/api/users/login/**", "/api/users", "/api/users/password", "/api/public/**","/api/ai/**","/api/weather/**","/api/kakao/**","/api/users/email/**","/api/crawl/**","/api/google/**","/api/opinions/place/**","/api/notices/**","/api/tarot/**"); // 로그인, 회원가입 등 제외
